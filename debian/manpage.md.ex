...
qt6-svg - program to do something

# SYNOPSIS

**qt6-svg** **-e** _this_ [**\-\-example=that**] [{**-e** | **\-\-example**} _this_]
                 [{**-e** | **\-\-example**} {_this_ | _that_}]

**qt6-svg** [{**-h** | *\-\-help**} | {**-v** | **\-\-version**}]

# DESCRIPTION

This manual page documents briefly the **qt6-svg** and **bar** commands.

This manual page was written for the Debian distribution because the
original program does not have a manual page. Instead, it has documentation
in the GNU info(1) format; see below.

**qt6-svg** is a program that...
...
:   The system-wide configuration file to control the behaviour of
    qt6-svg. See **foo.conf**(5) for further details.
...
**qt6-svg** provides some return codes, that can be used in scripts:
